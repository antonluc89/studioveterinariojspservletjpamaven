package it.studioveterinariojspservletmavenjpa.listener;
...
public class LocalEntityManagerFactoryListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		try {
			entityManagerFactory = Persistence.createEntityManagerFactory("studioveterinariojspservletmaven_unit");
		} catch (Throwable ex) {
